...
function setAdminDetails($db,$admin_details)
{
    ...
    ----------------------------------------------------*/
    $create_admin =  $db->prepare("INSERT INTO `sh_admins` (email,name,username,email_verified,role,image,password,remember_token,created_at,updated_at) VALUES (:email,:name,:username,:verified,:role,:image,:password,:token,:created,:updated)");
   ...
   $last_insert_id = $db->lastInsertId();
    ...
    --------------------------------------------------------*/
   $role_assign = $db->prepare("INSERT INTO `sh_model_has_roles` (role_id,model_type,model_id) VALUES (:role_id,:model,:model_id)");
    /*--------------------------------------------------------
