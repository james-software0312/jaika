                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.frontend.new.user')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="without_vat_number">Without VAT Number</label>
                                    <input type="text" class="form-control"  id="without_vat_number" name="without_vat_number" placeholder="Without VAT Number">
                                </div>
