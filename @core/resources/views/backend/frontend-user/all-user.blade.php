                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#"
                                                           ...
                                                           data-without_vat_number="{{$data->without_vat_number}}"
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.frontend.user.update')}}" id="user_edit_modal_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="without_vat_number">{{__('Without Vat Number')}}</label>
                            <input type="text" class="form-control"  id="without_vat_number" name="without_vat_number" placeholder="{{__('Without Vat Number')}}">
                        </div>
                        <div class="form-group">
        ...
        (function($){
            ...
            $(document).ready(function() {
                ...
                $(document).on('click','.user_edit_btn',function(e){
                    ...
                    form.find('#vat_number').val(el.data('vat_number'));
                    form.find('#without_vat_number').val(el.data('without_vat_number'));
